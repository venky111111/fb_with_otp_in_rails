...
ActiveRecord::Schema[7.1].define(version: 2024_01_29_012242) do
  ...
  create_table "otpsetups", force: :cascade do |t|
    t.boolean "verified"
    t.string "tmp_code"
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_otpsetups_on_user_id"
  end
  ...
  add_foreign_key "otpsetups", "users"
